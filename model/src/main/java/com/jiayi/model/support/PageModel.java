...
public class PageModel<T> implements Serializable {
    ...
    private PageModel(List<T> listObject, int pageNo, int pageSize, int totalPageNo, long totalItems) {
        this.pageNo = pageNo;
     ...
     */
    public static <T> PageModel<T> newInstance(List<T> listObject, int pageNo, int pageSize, int totalPageNo, long totalItems) {
        return new PageModel<T>(listObject, pageNo, pageSize, totalPageNo, totalItems);
    }
    ...
    public static <T> PageModel<T> newInstance(List<T> listObject, PageModel pageModel) {
        return new PageModel<T>(listObject, pageModel.getPageNo(), pageModel.getPageSize(),
